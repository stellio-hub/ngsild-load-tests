...
* Follow [instructions to setup Go and xk6](https://grafana.com/docs/k6/latest/extensions/run/build-k6-binary-using-go/).
...
```sh
INITIAL_NUMBER_OF_ENTITIES=10 ./run.sh src/tests/merge-entity.js 10 10000 10m
```
